...
const Chat = () => {
  ...
  return selectedUser ? (
    <div className="h-full relative
     overflow-scroll  backdrop-blur-lg">
      {/* This is the chat header section */}
          ...
          messages.map((msg , index) => (
            <div className={`flex items-end gap-2 justify-end ${msg.senderId !== authUser._id && 'flex-row-reverse' }`} key={index} > 
            {
              msg.image ? (
                ...
                border border-gray-700 overflow-hidden mb-8 rounded-lg" />
              ) : (
            ...
            <div className="text-center text-xs"> 
              <img src={msg.senderId === authUser._id  ? authUser.profilePic || assets.avatar_icon : selectedUser.profilePic || assets.avatar_icon} alt=""  className="w-7 aspect-[1/1] rounded-full"/>
      ...
      <div className=" absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3">
        <div className="flex-1 flex items-center bg-gray-100/12 px-3 rounded-full "> 
            ...
            <input onChange={(e) => handleImageUpload(e)} type="file" id="image" accept="image.png , image/jpeg"  hidden/>
            <label htmlFor="image">
